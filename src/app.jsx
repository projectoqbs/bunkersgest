...
export default function App() {
  ...
  const [dashFamilia, setDashFamiliaRaw] = useState(()=>localStorage.getItem("dashFamilia")||"negro");
  const setDashFamilia = v => { setDashFamiliaRaw(v); localStorage.setItem("dashFamilia",v); };
